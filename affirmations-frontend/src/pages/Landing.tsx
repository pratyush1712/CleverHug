					...
					<div className="rounded-lg shadow-lg">
						<div className="flex flex-col text-left align-left">
							...
							<p className="text-lg mb-6">
								CleverHug helps you schedule reminders for tasks, or send uplifting messages and affirmations to your future self.
								It’s a tool designed to keep you motivated and organized, making it easier for you to manage your time and maintain a
								positive mindset.
							</p>
